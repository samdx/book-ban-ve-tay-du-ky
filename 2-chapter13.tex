...
-- Hồi 27 đã được bàn đến ở phần {\bf Tổng Luận} (mục \nameref{sec:bieu_tuong_cua_hoi_thu_27}, chương \nameref{cha:cac_hinh_anh_bieu_tuong_khac_nhau_gioi_thieu_phat_hoc_trong_tay_du_ky}, trang \pageref{sec:bieu_tuong_cua_hoi_thu_26}). Tại đây, một số điểm sẽ được bàn thêm.
...
-- Hạnh Bồ Tát, theo Phật Giáo, là hạnh biểu hiện ba sức mạnh chính:
\begin{enumerate}[label=\itshape\arabic*\upshape/]
    \item \emph{Trí Tuệ là linh hồn};
    \item \emph{Thiền Định là sức mạnh}; và
    \item \emph{Từ Bi là sắc thái đặc thù, là sứ mệnh độ sinh}.
\end{enumerate}

Đường Tăng thì thiếu mất sức mạnh của định lực và của trí tuệ Vô Ngã. Vì thế, thảm kịch trong công phu giải thoát xảy ra. Đây là hiểm họa trên đường về giải thoát mà Tôn giả Tu Bồ Đề gọi là họa \emph{``bi phong''} thổi mạnh làm tan rã công phu giải thoát của hành giả, và đã căn dặn Tôn Ngộ Không cẩn thận đề phòng!
